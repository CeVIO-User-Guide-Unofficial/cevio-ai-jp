...
======
 ...
 『CeVIO AI』最新バージョン9.0.0.0 インストーラー（74MB）
----------------------------------------
...
[![CeVIO_AI_Setup_Download](image/dl_bt.png)](https://cevio.jp/storage/cevio_ai/CeVIO_AI_Setup_x64_(9.0.0.0).msi)
...
[「可不(KAFU)」インストーラー アップデート](home/kafu_update) 
 ...
 2023/12/21 アップデート（バージョン9.0.0.0）
---------------------------------


 ※先行公開バージョン8.7.0.0～9.0.0.0は、近日「バージョン9.0」として正式公開予定です。
...
> 
 ...
 ・マルチディスプレイ環境によっては、プリレンダリング中の進捗表示がずれたり、表示されないことがあった不具合を修正。
