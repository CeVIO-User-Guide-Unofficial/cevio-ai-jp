...
『CeVIO AI』最新バージョン9.1.11.0 インストーラー（74MB）
---------------------------------------
...
[![CeVIO_AI_Setup_Download](image/dl_bt.png)](https://cevio.jp/storage/cevio_ai/CeVIO_AI_Setup_x64_(9.1.11.0).msi)
...
[「奏兎める」ソングボイス アップデート](home/mell_update) 


[「双葉湊音」ソングボイス アップデート](home/futaba_update) 
...
2024/6/7 アップデート（バージョン9.1.11.0）
------------------------------


 （5/31 バージョン9.1.10.0先行公開）
...
**▼ソング関連** 
 ...
 ・「特殊記号の削除」で歌詞の日本語／英語に関わらず半角記号も全角記号も削除するように。※9.1.11.0更新
   

  

 ・特定の状況で音声波形が表示されないことがあったのを修正。※9.1.11.0更新
