...
======
 ...
 『CeVIO AI』最新バージョン8.7.1.0 インストーラー（73MB）
----------------------------------------
...
[![CeVIO_AI_Setup_Download](image/dl_bt.png)](https://cevio.jp/storage/cevio_ai/CeVIO_AI_Setup_x64_(8.7.1.0).msi)
...
**▼その他** 
 ...
 ・マウスカーソルがスクロールバー上にあるとき、ホイールスクロールはスクロールバーの垂直／水平に従うように。
...
![](image/CeVIO AI_banner_8.7.jpg)

 バージョン8.7では、ソングの音声波形表示やトークのフリーアクセントモードなどの新機能を実装。ビブラート調整など各種改善も行い、さらに使いやすくなりました。
