...
『CeVIO AI』最新バージョン9.1.9.0 インストーラー（74MB）
--------------------------------------
...
[![CeVIO_AI_Setup_Download](image/dl_bt.png)](https://cevio.jp/storage/cevio_ai/CeVIO_AI_Setup_x64_(9.1.9.0).msi)
...
------------------------------
 ...
 バージョン9.1.9では、ソングのCPU負荷軽減や補助ボタン、トークのフリーアクセントボタン実装などでさらに使いやすく。
   

 （5/9 バージョン9.1.8.0先行公開 ～ 5/16 バージョン9.1.9正式公開）
...
>  ※ピアノロールの背景がブラックのとき、選択範囲が明るくなり見やすくなりました。
 ...
 ・タイミング調整画面ではペンツールも選択系ツールも、[Alt]キーで状態ラインの一時切替に。
