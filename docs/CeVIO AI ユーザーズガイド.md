...
『CeVIO AI』最新バージョン9.1.8.0 インストーラー（74MB）
--------------------------------------
...
[![CeVIO_AI_Setup_Download](image/dl_bt.png)](https://cevio.jp/storage/cevio_ai/CeVIO_AI_Setup_x64_(9.1.8.0).msi)
...
>    
> 
>  ※ビブラート無効にすると、ピッチ調整画面でビブラートも含めたラインを描けます。
>    
> 
>   
> 
...
>  ※機械的な補正により本来の良さが失われる可能性もあります。補助的にお使いください。
 ...
 ・ソングボイス2.0.0で、音声波形表示やパラメータ計算のCPU高負荷を軽減。
   

 ※ソングボイス1.x.xのCPU負荷も改善予定。
...
>    
> 
>  ・選択範囲内に調整がなくても、選択範囲外に調整があると自動まとめ選択してしまう動作を修正。
>    
> 
>  ※自動まとめ選択は、右クリックメニュー「その他の操作」からオン／オフ可能です。
 ...
 ・消しゴムツールで選択範囲をクリックしたとき、（[Del]キー同様）範囲内の調整値や音符をまとめて消せるように。
