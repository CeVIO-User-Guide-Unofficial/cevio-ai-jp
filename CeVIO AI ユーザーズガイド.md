...
![](http://cevio.jp/guide/cevio_ai/image/header_image_title.png)
...
[動作環境](https://cevio.jp/guide/cevio_ai/firstguide/system_requirements/) 
  

[インストールと認証](https://cevio.jp/guide/cevio_ai/firstguide/install/) 
...
[各部の名前](https://cevio.jp/guide/cevio_ai/operation/) 
  

[メニュー](https://cevio.jp/guide/cevio_ai/operation/menu/) 
  

[トランスポート](https://cevio.jp/guide/cevio_ai/operation/transport/) 
  

[インフォパネル](https://cevio.jp/guide/cevio_ai/operation/infopanel/) 
  

[トラックヘッダ](https://cevio.jp/guide/cevio_ai/operation/trackhead/) 
  

[編集ツール（ソング）](https://cevio.jp/guide/cevio_ai/operation/edittool/) 
  

[調整ツール（ソング）](https://cevio.jp/guide/cevio_ai/operation/adjusttool/) 
...
[はじめてのトーク作成](https://cevio.jp/guide/cevio_ai/tutorial_talk/) 
  

[トークトラックの説明](https://cevio.jp/guide/cevio_ai/talktrack/) 
  

[セリフの入力と編集](https://cevio.jp/guide/cevio_ai/talktrack/talk_01/) 
  

[文のまとめ入力](https://cevio.jp/guide/cevio_ai/talktrack/longsentence/) 
  

[発声タイミングの調整](https://cevio.jp/guide/cevio_ai/talktrack/talk_02/) 
  

[セリフの表情設定](https://cevio.jp/guide/cevio_ai/talktrack/talk_05/) 
  

[音素グラフ（日本語）](https://cevio.jp/guide/cevio_ai/talktrack/phoneme/) 
  

[音素グラフ（英語）](https://cevio.jp/guide/cevio_ai/talktrack/phoneme_english/) 
  

[単語登録と辞書の管理（日本語）](https://cevio.jp/guide/cevio_ai/talktrack/talk_06/) 
  

[単語登録と発音記号（英語）](https://cevio.jp/guide/cevio_ai/talktrack/talk_01_english/) 
...
[セリフのインポート](https://cevio.jp/guide/cevio_ai/talktrack/talk_04/) 
...
[はじめてのソング作成](https://cevio.jp/guide/cevio_ai/tutorial_song/) 
  

[ソングトラックの説明](https://cevio.jp/guide/cevio_ai/songtrack/) 
  

[テンポ／拍子／調号／強弱](https://cevio.jp/guide/cevio_ai/songtrack/songtrack/) 
  

[音符の入力と編集](https://cevio.jp/guide/cevio_ai/songtrack/song_02/) 
  

[歌詞の入力（日本語）](https://cevio.jp/guide/cevio_ai/songtrack/song_04/) 
  

[歌詞の入力（英語）](https://cevio.jp/guide/cevio_ai/songtrack/song_04english/) 
  

[音符のプロパティ](https://cevio.jp/guide/cevio_ai/songtrack/song_03/) 
  

[歌声の調整①（編集ツール）](https://cevio.jp/guide/cevio_ai/songtrack/song_05/) 
  

[歌声の調整②（調整画面）](https://cevio.jp/guide/cevio_ai/songtrack/song_07/) 
  

[歌声の調整③（声質ほか）](https://cevio.jp/guide/cevio_ai/songtrack/song_06/) 
...
[オーディオトラックの操作](https://cevio.jp/guide/cevio_ai/audio/) 
...
[ショートカットキー](https://cevio.jp/guide/cevio_ai/shortcutkey/) 




[外部連携インターフェイス](https://cevio.jp/guide/cevio_ai/interface/) 




[よくある質問／既知の問題](https://cevio.jp/guide/cevio_ai/faq/) 
...
======
 ...
 『CeVIO AI』最新バージョン8.6.10.0 インストーラー（73MB）
-----------------------------------------
...
[![CeVIO_AI_Setup_Download](image/dl_bt.png)](https://cevio.jp/storage/cevio_ai/CeVIO_AI_Setup_x64_(8.6.10.0).msi)
...
[アップデートはこちら](home/maki_update) 
 ...
 2023/7/19 アップデート（バージョン8.6.5.0）
--------------------------------


 ※バージョン8.6の主な変更点は
 [2023/7/4 アップデート](#バージョン8.6.1.0) 
 をご覧ください。
 ...
 **[Ctrl+Shift+Tab]** 
 ...
 ※バージョン8.6.3.0で、調整画面の背景が正しく描画されないことがあった不具合も修正。
...
**▼ソング関連** 
 ...
 ・ショートカットキー
 **[Ctrl+Tab]** 
 がハスキー詳細調整画面に対応。以下のショートカットキーを追加。
...
> 
 ...
 ・アンチエイリアス描画時、グレー背景などで余計な水平線が見えることがあったのを修正。
...
![](image/CeVIO AI_banner_8.6.jpg)
 ...
 （7/4 バージョン8.6.1.0先行公開。7/21 バージョン8.6.5.0正式公開。）
...
**▼その他** 
 ...
 ・ボイスアップデートのお知らせを、インストール済みで古い場合のみ表示する機能を実装。
   

 ※バージョン8.6正式公開後、しばらく普及を待ってから適用予定。
...
**▼ソング関連** 
 ...
 ※垂直移動はピッチ、横移動はタイミング以外の調整が範囲内にあるとき、まとめ選択するように。
 ...
 ※「ソング」メニューや右クリックメニュー「その他の操作」から設定可能。
 ...
 ※「英語歌詞の自動分割」はメニューに移動し、オプションからは削除。
   

  

 ・音素単位でタイミング調整したときの最小間隔をバージョン8.3以前に戻しました。
...
**▼トーク関連** 
 ...
 ・「トーク」メニューとセリフリストの右クリックメニューの「検索」の位置を変更。
...
**▼ソング関連** 
 ...
 ・オプションの「ソング設定」に「調整画面の色の設定」を追加。
   

 ※右クリックメニューの「表示」の「色の設定」と同じ機能を呼び出せます。
 ...
 ・バージョン8.5.2.0から、長時間の見やすさを考慮して「感情」スライダーのグラフィックを元に戻しました。
   

  

 ・バージョン8.5.2.0で、音符のまとめ選択から水平ドラッグ移動できない不具合を修正。
...
**▼トーク関連** 
 ...
 ・ショートカットキー
 **[F5]** 
 で再生停止したとき、停止位置のセリフ先頭にポジションカーソルを移動して選択するように。
 ...
 ・バージョン8.5.2.0でフルスクリーン表示時、プリレンダリング処理ウィンドウの位置が正しくなかったのを修正。
   

  

 ・バージョン8.5.2.0で、感情グラフや各スライダーが以前ほど縮まなくなっていたのを修正。
...
**▼その他** 
 ...
 ・オフライン起動時にメッセージを表示するように。
   


 2023/5/1 アップデート（バージョン8.5.2.0）
-------------------------------
...
> 
 ...
 ・「すずきつづみ」「星界」「狐子(COKO)」で、「感情」スライダーのグラフィックを更新。
   

 ※バージョン8.5.3.0で、長時間の見やすさを考慮して元に戻しました。
...
> 
 ...
 2022/12/20 アップデート（バージョン8.3.22.0～8.4.0.0）
------------------------------------------
...
>    
> 
>  ※今後、ミックスダウンの形式指定対応、24bitオーディオファイルのインポート対応等も計画しています。
>    
> 
> 
...
> 
 ...
 Copyright © CeVIO All rights reserved.
